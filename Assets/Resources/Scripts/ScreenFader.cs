...
/// <summary>
/// <remarks>reuse of the FadeInOut script found on Unify Community wiki</remarks>
/// </summary>
public class ScreenFader : MonoBehaviour {
    ...
    // initiate a fade from the current screen color (set using "SetScreenOverlayColor") 
    //  towards "newScreenOverlayColor" taking "fadeDuration" seconds
